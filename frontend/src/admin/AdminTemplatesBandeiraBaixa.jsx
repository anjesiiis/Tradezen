...
import { fetchAtivoCandles, templatesBandeiraBaixaApi, clearAdminToken } from "./adminApi";
...
export default function AdminTemplatesBandeiraBaixa() {
  ...
  async function carregarTemplates() {
    try {
      setTemplates(await templatesBandeiraBaixaApi.list());
    } catch {
  ...
  async function salvarNovo() {
    ...
    try {
      ...
      await templatesBandeiraBaixaApi.create({
  ...
  async function abrirTemplate(template, readOnly) {
    setMensagem(null);
    try {
      const completo = await templatesBandeiraBaixaApi.get(template.id);
  ...
  async function salvarEdicao() {
    ...
    setMensagem(null);
    try {
      await templatesBandeiraBaixaApi.update(editando.id, {
  ...
  async function remover(id) {
    ...
    try {
      await templatesBandeiraBaixaApi.remove(id);
      carregarTemplates();
    } catch {
    ...
    <AdminShell>
      <div className="admin-header">
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <span className="admin-header-title">Admin · Templates Bandeira de Baixa</span>
          <AdminPatternNav active="bandeira-baixa" />
        </div>
