...
const PERIODOS = ["3mo", "6mo", "1y", "2y", "5y"];
const INTERVALOS = ["1d", "1wk", "60m"];
const PADDING = 15;
const PASSOS = ["ombro_esq", "cabeca", "ombro_dir", "neck1", "neck2"];
...
export default function AdminTemplates() {
  ...
  async function salvarEdicao() {
    ...
    setMensagem(null);
    try {
      await updateTemplate(editando.id, {
      ...
      <main className="admin-main">
        ...
        {editando ? (
          ...
          <section className="admin-card" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            {candlesContexto && (
              <>
                <TemplateMarkerChart candles={candlesContexto} onChange={setPontos} />
